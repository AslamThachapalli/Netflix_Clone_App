...
import 'get_released_in_past_year_data_test.mocks.dart';

void main() {
  late MockClient mockClient;
  late GetReleasedInPastYearData datasource;

  setUp(() {
    mockClient = MockClient();
    datasource = GetReleasedInPastYearData(mockClient);
  });
  ...
  const url = Apis.releasedInPastYearApi;
  ...
  group('getData', () {
    test(
      ...
      () {
        ...
        datasource.getData();
        //assert
        verify(mockClient.get(Uri.parse(Apis.releasedInPastYearApi)));
      },
    );
