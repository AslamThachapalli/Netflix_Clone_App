...
import 'get_south_indian_cinema_data_test.mocks.dart';

void main() {
  late MockClient mockClient;
  late GetSouthIndianCinemaData datasource;

  setUp(() {
    mockClient = MockClient();
    datasource = GetSouthIndianCinemaData(mockClient);
  });
  ...
  const url = Apis.southIndianCinemaApi;
  ...
  group('getData', () {
    test(
      ...
      () {
        ...
        datasource.getData();
        //assert
        verify(mockClient.get(Uri.parse(Apis.southIndianCinemaApi)));
      },
    );
