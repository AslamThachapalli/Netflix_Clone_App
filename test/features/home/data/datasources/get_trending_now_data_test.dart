...
import 'get_trending_now_data_test.mocks.dart';

void main() {
  late MockClient mockClient;
  late GetTrendingNowData datasource;

  setUp(() {
    mockClient = MockClient();
    datasource = GetTrendingNowData(mockClient);
  });
  ...
  group('getData', () {
    test(
      ...
      () {
        ...
        datasource.getData();
        //assert
        verify(mockClient.get(Uri.parse(Apis.trendingNowApi)));
      },
    );
