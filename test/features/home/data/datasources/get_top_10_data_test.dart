...
import 'get_top_10_data_test.mocks.dart';

void main() {
  late MockClient mockClient;
  late GetTop10Data datasource;

  setUp(() {
    mockClient = MockClient();
    datasource = GetTop10Data(mockClient);
  });
  ...
  const url = Apis.top10TvShowsApi;
  ...
  group('getData', () {
    test(
      ...
      () {
        ...
        datasource.getData();
        //assert
        verify(mockClient.get(Uri.parse(Apis.top10TvShowsApi)));
      },
    );
